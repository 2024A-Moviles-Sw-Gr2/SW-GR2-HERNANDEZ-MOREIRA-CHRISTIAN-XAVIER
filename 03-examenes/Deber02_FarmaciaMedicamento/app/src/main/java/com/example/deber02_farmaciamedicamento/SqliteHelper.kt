...
class SqliteHelper(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        CREATE TABLE Farmacia(
            ...
            latitudFarmacia REAL,
            longitudFarmacia REAL
        );
    """.trimIndent()
    ...
    fun crearFarmacia(
        ...
        abierta24Horas: Boolean,
        latitudFarmacia: Double,
        longitudFarmacia: Double
    ): Boolean {
        ...
        valuesToStore.put("latitudFarmacia", latitudFarmacia)
        valuesToStore.put("longitudFarmacia", longitudFarmacia)
    ...
    fun actualizarFarmacia(
        ...
        valuesToUpdate.put("latitudFarmacia", latitudFarmacia)
        valuesToUpdate.put("longitudFarmacia", longitudFarmacia)
