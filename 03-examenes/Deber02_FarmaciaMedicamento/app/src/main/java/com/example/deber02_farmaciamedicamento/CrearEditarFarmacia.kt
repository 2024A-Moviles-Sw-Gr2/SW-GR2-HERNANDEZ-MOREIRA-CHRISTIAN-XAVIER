...
class CrearEditarFarmacia : AppCompatActivity() {
    ...
    private lateinit var latitudFarmacia: EditText
    private lateinit var longitudFarmacia: EditText
        ...
        if (farmaciaSeleccionada != null) {
            ...
            guardarFarmacia.setOnClickListener {
                DataBase.tables?.actualizarFarmacia(
                    ...
                    latitudFarmacia.text.toString().toDouble(),
                    longitudFarmacia.text.toString().toDouble()
                )
    ...
    private fun populateFields(farmacia: Farmacia) {
        ...
        latitudFarmacia.setText(farmacia.latitudFarmacia.toString())
        longitudFarmacia.setText(farmacia.longitudFarmacia.toString())
    }
